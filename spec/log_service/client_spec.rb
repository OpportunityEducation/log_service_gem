...
describe LogService::Client do
  ...
  let(:api_url) { "http://fake.oe-log-service.herokuapp.com:fakeport" }
  let(:client) { LogService::Client.new(:project_id => project_id) }
  let(:read_timeout) { 40 }

  before do
    ENV["LOG_SERVICE_PROJECT_ID"] = nil
    ENV["LOG_SERVICE_WRITE_KEY"] = nil
    ENV["LOG_SERVICE_READ_KEY"] = nil
    ENV["LOG_SERVICE_API_URL"] = nil
    ENV["LOG_SERVICE_READ_TIMEOUT"] = nil
  end
