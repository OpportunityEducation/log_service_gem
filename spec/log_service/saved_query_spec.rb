...
describe LogService do
  let(:client) do
    LogService::Client.new(
      project_id: "12341234",
      master_key: "abcdef",
      api_url: "https://notreal-oe-log-service.herokuapp.com"
    )
  end
  ...
  describe "#saved_queries" do
    describe "#all" do
      ...
      it "returns all saved queries" do
        ...
        stub_log_service_get(saved_query_endpoint, 200, all_saved_queries)
    ...
    describe "#create" do
      ...
      it "raises an error when creation is unsuccessful" do
        ...
        }.to raise_error(LogService::BadRequestError)
      end
    end
