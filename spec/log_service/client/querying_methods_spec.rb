...
describe LogService::Client do
  ...
  describe "#query" do
    ...
    describe "with a valid client" do
      ...
      it "should raise a failed responses" do
        ...
        stub_log_service_get(url, 401, :error => {})
        expect {
          query.call(query_name, event_collection, {})
        }.to raise_error(LogService::AuthenticationError)
      ...
      it "should call API with post body if method opton is set to post " do
        ...
        stub_log_service_post(expected_url, 200, :result => 1)
  ...
  describe "#count" do
    ...
    before do
      stub_log_service_get(url, 200, :result => 10)
    end
  ...
  describe "#query_url" do
    ...
    it "should returns the URL for a query" do
      ...
      expect(response).to eq 'https://notreal-oe-log-service.herokuapp.com/3.0/projects/12345/queries/count?event_collection=users&api_key=abcde'
    end
    ...
    it "should exclude the api key if option is passed" do
      ...
      expect(response).to eq 'https://notreal-oe-log-service.herokuapp.com/3.0/projects/12345/queries/count?event_collection=users'
    end
