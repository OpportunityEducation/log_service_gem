require 'log_service/http'
require 'log_service/version'
require 'log_service/client/publishing_methods'
require 'log_service/client/querying_methods'
require 'log_service/client/maintenance_methods'
require 'log_service/client/saved_queries'
require 'openssl'
require 'multi_json'
require 'base64'
require 'cgi'
...
module LogService
  class Client
    include LogService::Client::PublishingMethods
    include LogService::Client::QueryingMethods
    include LogService::Client::MaintenanceMethods
    ...
    def process_response(status_code, response_body)
      ...
      when 403
        raise ForbiddenError.new(response_body)
      when 404
