...
module LogService
  class Client
    module QueryingMethods
      ...
      # https://oe-log-service.herokuapp.com/api/reference/#count-resource
      #
      ...
      # See detailed documentation here:
      # https://oe-log-service.herokuapp.com/api/reference/#count-unique-resource
      #
      # @param event_collection
      # @param params [Hash] (optional)
      ...
      # See detailed documentation here:
      # https://oe-log-service.herokuapp.com/api/reference/#minimum-resource
      #
      # @param event_collection
      # @param params [Hash] (optional)
      #   target_property (required)
      ...
      # See detailed documentation here:
      # https://oe-log-service.herokuapp.com/api/reference/#maximum-resource
      #
      # @param event_collection
      # @param params [Hash] (optional)
      #   target_property (required)
      ...
      # Runs a sum query.
      # See detailed documentation here:
      # https://oe-log-service.herokuapp.com/api/reference/#sum-resource
      #
      # @param event_collection
      # @param params [Hash] (optional)
      #   target_property (required)
      ...
      # See detailed documentation here:
      # https://oe-log-service.herokuapp.com/api/reference/#average-resource
      #
      # @param event_collection
      # @param params [Hash] (optional)
      #   target_property (required)
      ...
      # Runs a median query.
      # See detailed documentation here:
      # https://oe-log-service.herokuapp.com/api/reference/#median-resource
      #
      # @param event_collection
      # @param params [Hash] (optional)
      #   target_property (required)
      ...
      # See detailed documentation here:
      # https://oe-log-service.herokuapp.com/api/reference/#percentile-resource
      #
      # @param event_collection
      # @param params [Hash] (optional)
      #   target_property (required)
      ...
      # See detailed documentation here:
      # https://oe-log-service.herokuapp.com/api/reference/#select-unique-resource
      #
      # @param event_collection
      # @param params [Hash] (optional)
      #   target_property (required)
      ...
      # See detailed documentation here:
      # https://oe-log-service.herokuapp.com/api/reference/#extraction-resource
      #
      # @param event_collection
      # @param params [Hash] (optional)
      #   target_property (required)
      ...
      # Runs a funnel query.
      # See detailed documentation here:
      # https://oe-log-service.herokuapp.com/api/reference/#funnel-resource
      #
      # @param event_collection
      # @param params [Hash] (optional)
      #   steps (required)
      ...
      # See detailed documentation here:
      # https://oe-log-service.herokuapp.com/data-analysis/multi-analysis/
      #
      ...
      def post_query(analysis_type, event_collection, params={})
        ...
        LogService::HTTP::Sync.new(self.api_url, self.proxy_url, self.read_timeout).post(
          :path => api_query_resource_path(analysis_type),
          :headers => api_headers(self.read_key, "sync"),
          :body => MultiJson.encode(query_params)
        )
      rescue Exception => http_error
        raise HttpError.new("Couldn't perform #{@analysis_type} on OE Log Service: #{http_error.message}", http_error)
      end
      ...
      def get_response(url)
        uri = URI.parse(url)
        LogService::HTTP::Sync.new(self.api_url, self.proxy_url, self.read_timeout).get(
      ...
      def api_query_resource_path(analysis_type)
        "/api/projects/#{self.project_id}/queries/#{analysis_type}"
      end
    end
  end
end
